...
## Last update Tue Jan 24 22:55:40 2017 Bonaldi Jordan
##

SRC	=	main.c				\
		handlers/file_handlers.c	\
		handlers/struct_handlers.c	\
		handlers/map_handlers.c		\
		handlers/windows_handlers.c	\
		handlers/drawer.c		\
		handlers/player_handler.c	\
		handlers/event_handlers.c	\
		src/my_draw_line.c		\
		src/my_put_pixel.c		\
		src/move_forward.c		\
		src/move_backward.c		\
